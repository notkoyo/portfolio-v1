import { SiExpress, SiPostgresql, SiJest, SiNetlify } from "react-icons/si";
...
export const ExpressIcon = () => <SiExpress size={24} strokeWidth={1.1} />;

export const PSQLIcon = () => <SiPostgresql size={24} strokeWidth={1} />;

export const JestIcon = () => <SiJest size={24} />

export const NetlifyIcon = () => <SiNetlify size={24} />
