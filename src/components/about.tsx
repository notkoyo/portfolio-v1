  ...
  return (
    ...
    >
      ...
      <p className="mb-5">
        ...
        programming, which very quickly became a passion of mine. When I arrived
        back in England, I enrolled in a coding bootcamp with{" "}
        <a
      ...
      <p className="mb-5">
        ...
        <span className="font-medium">full-time position</span> as a <span className="font-medium">front-end</span> or <span className="font-medium">full-stack</span> software
        developer.
      </p>
      ...
      <p>
        ...
        solidifying my{" "}
        <span className="font-medium">German</span> language skills.
      </p>
    </motion.section>
  );
}
