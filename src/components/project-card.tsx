...
export default function ProjectCard({
  ...
  return (
    ...
    >
      <section className="relative max-w-[42rem] overflow-hidden rounded-xl borderBlack bg-gray-100 transition hover:bg-gray-200 sm:h-[20rem] sm:pr-8 sm:group-even:pl-12">
